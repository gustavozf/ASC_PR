...
tipo1 = 'lbp'
dir_origem_tipo1 = '/home/gustavozf/Documentos/Projeto/Saidas/OUT/zl_lbp_1z_1s/Mono/predicts/'
# Diretório e tipo de origem
tipo2 = 'rlbp'
dir_origem_tipo2 = '/media/rafael/Dados/Mestrado/base_juliano_segmentada_manual_concatenada_6s_rp/'
...
regras = [tipo1, tipo2, 'soma', 'produto', 'maximo']
