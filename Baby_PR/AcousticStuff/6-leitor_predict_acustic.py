...
# Se n for windows...
if not is_win:
	dir_origem_tipo1 = '/home/gustavozf/Documentos/Projeto/Saidas/Predictacoustic/ssd/'
	dir_original_svm = '/home/gustavozf/Documentos/Projeto/Saidas/OUTacoustic/'
# Se n for Linux...
else:
    dir_origem_tipo1 = 'D:/'
...
for f in range(1, qtde_folds+1):
	...
	fold_original = dir_original_svm + 'test/fold' + str(f) + "-" + tipo1 + '.svm'
	#fold_results[0] = dir_origem_tipo1 + 'fold'  + "-" + str(f)  + "-" + escala + '-fusao-soma-' + early + tipo1 + '.svm.predict'
	fold_results[0] = dir_origem_tipo1 + 'fold' + str(f)+ '/fold' + str(f)+'-' + tipo1 +'.svm.predict'
