...
# Se for windows...
if not is_win:
	dir_origem_tipo1 = '/home/gustavozf/Documentos/Projeto/Saidas/Fusao/'
	dir_original_svm = '/home/gustavozf/Documentos/Projeto/Saidas/OUT/'
# Se for Linux...
else:
    dir_origem_tipo1 = 'D:/'
...
dir_origem_tipo1 += "fusao_1+2_1z_1s_lbp/"
dir_original_svm+= "lbp_zl_1z_1s/Spectrograms2/"
#####################################################################
...
for f in range(1, qtde_folds+1):
	...
	#fold_results[0] = dir_origem_tipo1 + 'fold'  + "-" + str(f)  + "-" + escala + '-fusao-soma-' + early + tipo1 + '.svm.predict'
	fold_results[0] = dir_origem_tipo1 + 'fold'  + "-" + str(f)  + '-fusao-produto-lbp-lbp.svm.predict'
