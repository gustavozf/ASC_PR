...
tipo = 'lbp';
dir_origem = '/home/gustavozf/Documentos/Projeto/Saidas/Predict/';
dir_origem = strcat(dir_origem, 'mel_lbp_15z_1s/Spectrograms2/');
% Linear = 'zl'. Mel = 'mel'
escala = 'mel';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Diretório para armazenar os resultados
dir_resultados = strcat(dir_origem, 'predicts/');
% Cria o diretório
